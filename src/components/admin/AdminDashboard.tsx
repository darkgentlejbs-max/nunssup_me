      ...
      <div className="bg-brand-900 text-white border-b border-brand-800 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <div className="flex items-center gap-2 text-gold-300 text-xs font-semibold uppercase tracking-wider mb-1 font-dodum">
                <ShieldCheck className="w-4 h-4 text-emerald-400" />
                <span>원장님 통합 비즈니스 관리자 센터</span>
              </div>
              <h1 className="text-2xl sm:text-3xl font-bold font-dodum tracking-wide text-white flex items-center gap-2 flex-wrap">
                <span className="tracking-wider">눈썹</span>
                <span className="font-normal text-gold-300">:</span>
                <span className="tracking-wider">미</span>
                <span className="font-serif-kr text-gold-300 font-bold ml-0.5">眉</span>
                <span className="text-xl sm:text-2xl font-bold text-stone-100 font-dodum ml-1">
                  스마트 CRM
                </span>
              </h1>
              <p className="text-xs sm:text-sm text-stone-300 mt-1.5 font-dodum">
          ...
          <div className="flex items-center gap-2 border-b border-brand-800 overflow-x-auto pb-1">
            ...
            >
              ...
              {appointments.filter(a => a.status === 'pending').length > 0 && (
                <span className="text-[11px] px-1.5 py-0.2 bg-rose-500 text-white rounded-full font-mono">
